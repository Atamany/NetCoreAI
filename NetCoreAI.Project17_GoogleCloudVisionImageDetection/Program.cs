...
class Program
{
    ...
    {
        Console.WriteLine("Google Cloud Vision API ile Görsel Tespiti Yapılıyor...");
    ...
    static async Task<string> DetectObjects(string path)
    {
        ...
        var requestBody = new
        {
            requests = new[] { new { image = new { content = base64Image }, features = new[] { new { type = "LABEL_DETECTION", maxResults = 10 } } } }
        };
